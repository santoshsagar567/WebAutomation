...
public class DatePicker_RedBus {
	...
	public static void main(String[] args) {
		DatePicker_RedBus bot = new DatePicker_RedBus();
		try {
			bot.setUp();
			bot.openRedBus();
	...
	public void selectDate(String dateStr) throws InterruptedException {
		...
		WebElement dateField = driver
				.findElement(By.xpath("//div[@class='dateInputWrapper___874b87 dateHighlight___4d1fef']"));
	...
	private void navigateToMonth(int targetMonth, int targetYear) throws InterruptedException {
		...
		for (int attempt = 0; attempt < 24; attempt++) { // max 24 months ahead
			...
			WebElement header = wait
					.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[@class='monthYear___a4142d']")));
